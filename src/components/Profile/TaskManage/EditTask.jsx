...
const EditTask = ({ status, handleEditTaskModal }) => {
                    ...
                    <div className='relative bg-white rounded-md shadow-lg w-[500px] text-[15px] mx-auto inline-block'>
                        ...
                        <div className="p-6">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className='mt-4'>
                                    <button type='submit' className='text-right px-4 py-1.5 bg-[#7557fafb] text-white rounded shadow-md hover:bg-[#3d3bbefb]'>Edit Task</button>
                                </div>
                            </form>
                        </div>
                    </div>
